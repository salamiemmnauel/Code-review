<!doctype html>
<html> <!--keywords which defines that how web browser will format and display the content-->
  <head> <!--contains all the heading contents-->
  ...
  <body> <!--the start of the document's body--> 
